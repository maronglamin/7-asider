...
|------|------|---------------|
| **Web** | 7a-side Web | Authorized JavaScript origins: `https://seven-aside.phantommetrics.gm`, `http://localhost:8081`. Authorized redirect URIs: `https://seven-aside.phantommetrics.gm`, `http://localhost:8081` (Expo web uses the page origin). |
...
## 6. iOS App Store (Sign in with Apple)
